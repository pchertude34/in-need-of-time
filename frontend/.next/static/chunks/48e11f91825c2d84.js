(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, r, t) => {
    ...
    class s extends o.default.Component {
      ...
      static getDerivedStateFromError(e) {
        if ((0, u.isHTTPAccessFallbackError)(e)) return { triggeredStatus: (0, u.getAccessFallbackHTTPStatus)(e) };
        throw e;
      }
    ...
    function i({ notFound: e, forbidden: r, unauthorized: t, children: n }) {
      ...
      return e || r || t
        ? (0, a.jsx)(s, { pathname: u, notFound: e, forbidden: r, unauthorized: t, missingSlots: i, children: n })
  ...
  (e, r, t) => {
        ...
        (super(...e),
          (this.handlePotentialScroll = () => {
            ...
            if (e.apply) {
              ...
              if (
                (n &&
                  (t = "top" === n ? document.body : (document.getElementById(n) ?? document.getElementsByName(n)[0])),
                t || (t = "undefined" == typeof window ? null : (0, S.findDOMNode)(this)),
    ...
    function w({ segmentPath: e, children: r }) {
      ...
      return (0, o.jsx)(j, { segmentPath: e, focusAndScrollRef: t.focusAndScrollRef, children: r });
    }
    function C({ tree: e, segmentPath: r, debugNameContext: t, cacheNode: n, params: a, url: l, isActive: f }) {
      ...
      let { tree: m } = h,
        ...
        _ = "object" == typeof y && null !== y && "function" == typeof y.then ? (0, u.use)(y) : y;
      if (!_) {
        if (f) {
          let e = n.lazyData;
          if (null === e) {
  ...
  (e, r, t) => {
    ...
    let n = e.r(246346).createRenderSearchParamsFromClient;
    ("function" == typeof t.default || ("object" == typeof t.default && null !== t.default)) &&
      void 0 === t.default.__esModule &&
      (Object.defineProperty(t.default, "__esModule", { value: !0 }),
      Object.assign(t.default, t),
  ...
  (e, r, t) => {
    ...
    let n = e.r(283468).createRenderParamsFromClient;
    ("function" == typeof t.default || ("object" == typeof t.default && null !== t.default)) &&
      void 0 === t.default.__esModule &&
      (Object.defineProperty(t.default, "__esModule", { value: !0 }),
      Object.assign(t.default, t),
      ...
      if (t)
        switch (t.type) {
          ...
          case "prerender-runtime":
            throw Object.defineProperty(
              new l.InvariantError("createSearchParamsFromClient should not be called in a runtime prerender."),
              "__NEXT_ERROR_CODE",
          ...
          case "unstable-cache":
            throw Object.defineProperty(
              new l.InvariantError("createSearchParamsFromClient should not be called in cache contexts."),
              "__NEXT_ERROR_CODE",
    ...
    function m(e, r) {
      ...
      if (t)
        switch (t.type) {
          ...
          case "unstable-cache":
            throw Object.defineProperty(
              new l.InvariantError("createServerSearchParamsForServerPage should not be called in cache contexts."),
              "__NEXT_ERROR_CODE",
    ...
    function g(e) {
      ...
      if (r)
        switch (r.type) {
          ...
          case "unstable-cache":
            throw Object.defineProperty(
              new l.InvariantError("createPrerenderSearchParamsForClientPage should not be called in cache contexts."),
              "__NEXT_ERROR_CODE",
            ...
            l = new Proxy(u, {
              get(e, r, t) {
                ...
                switch (r) {
                  case "then":
                    return (
                      (0, c.annotateDynamicAccess)("`await searchParams`, `searchParams.then`, or similar", n),
                      o.ReflectAdapter.get(e, r, t)
                    );
                  case "status":
                    return (
                      (0, c.annotateDynamicAccess)("`use(searchParams)`, `searchParams.status`, or similar", n),
                      o.ReflectAdapter.get(e, r, t)
                    );
                  default:
              ...
              get(e, r, t) {
                ...
                if ("string" == typeof r && "then" === r) {
                  ...
                  i.dynamicShouldError
                    ? (0, f.throwWithStaticGenerationBailoutErrorWithDynamicError)(i.route, e)
                    : "prerender-ppr" === d.type
                      ? (0, c.postponeWithTracking)(i.route, e, d.dynamicTracking)
  ...
  (e, r, t) => {
    ...
    function h(e, r) {
      ...
      if (t)
        switch (t.type) {
          ...
          case "unstable-cache":
            throw Object.defineProperty(
              new s.InvariantError("createParamsFromClient should not be called in cache contexts."),
              "__NEXT_ERROR_CODE",
              { value: "E736", enumerable: !1, configurable: !0 },
            );
          case "prerender-runtime":
            throw Object.defineProperty(
              new s.InvariantError("createParamsFromClient should not be called in a runtime prerender."),
              "__NEXT_ERROR_CODE",
    ...
    function g(e, r) {
      ...
      if (t)
        switch (t.type) {
          ...
          case "unstable-cache":
            throw Object.defineProperty(
              new s.InvariantError("createServerParamsForRoute should not be called in cache contexts."),
              "__NEXT_ERROR_CODE",
    ...
    function y(e, r) {
      ...
      if (t)
        switch (t.type) {
          ...
          case "unstable-cache":
            throw Object.defineProperty(
              new s.InvariantError("createServerParamsForServerSegment should not be called in cache contexts."),
              "__NEXT_ERROR_CODE",
    ...
    function b(e) {
      ...
      if (!r)
        throw Object.defineProperty(
          new s.InvariantError("Missing workStore in createPrerenderParamsForClientSegment"),
          "__NEXT_ERROR_CODE",
      ...
      if (t)
        switch (t.type) {
          ...
          case "prerender-client":
            ...
            if (n) {
              for (let a in e) if (n.has(a)) return (0, d.makeHangingPromise)(t.renderSignal, r.route, "`params`");
            }
            break;
          case "cache":
          case "private-cache":
          case "unstable-cache":
            throw Object.defineProperty(
              new s.InvariantError("createPrerenderParamsForClientSegment should not be called in cache contexts."),
              "__NEXT_ERROR_CODE",
                          ...
                          Object.defineProperty(o, e, {
                            get() {
                              ...
                              "prerender-ppr" === n.type
                                ? (0, u.postponeWithTracking)(t.route, r, n.dynamicTracking)
                                : (0, u.throwToInterruptStaticGeneration)(r, t, n);
                            },
                            enumerable: !0,
                          }));
                    }),
    ...
    function s({ Component: r, serverProvidedParams: t }) {
      ...
      if (null !== t) ((s = t.searchParams), (i = t.params));
        ...
        ((i = null !== e ? e.parentParams : {}),
          (s = (0, u.urlSearchParamsToParsedUrlQuery)((0, c.use)(l.SearchParamsContext))));
      }
      if ("undefined" == typeof window) {
        let t,
          o,
          { workAsyncStorage: c } = e.r(767885),
          u = c.getStore();
        if (!u)
          throw Object.defineProperty(
            new a.InvariantError("Expected workStore to exist when handling searchParams in a client Page."),
            "__NEXT_ERROR_CODE",
            { value: "E564", enumerable: !1, configurable: !0 },
          );
        let { createSearchParamsFromClient: l } = e.r(624211);
        t = l(s, u);
        let { createParamsFromClient: d } = e.r(698427);
        return ((o = d(i, u)), (0, n.jsx)(r, { params: o, searchParams: t }));
      }
      {
        let { createRenderSearchParamsFromClient: t } = e.r(785401),
          a = t(s),
          { createRenderParamsFromClient: o } = e.r(564114),
          c = o(i);
  ...
  (e, r, t) => {
    ...
    function u({ Component: r, slots: t, serverProvidedParams: u }) {
      ...
      if ("undefined" == typeof window) {
        ...
        let { createParamsFromClient: s } = e.r(698427);
        return ((o = s(l, u)), (0, n.jsx)(r, { ...t, params: o }));
      }
      {
        let { createRenderParamsFromClient: a } = e.r(564114),
          o = a(l);
