(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  "[project]/in-need-of-time/node_modules/next/dist/compiled/react-server-dom-turbopack/cjs/react-server-dom-turbopack-client.browser.development.js [app-client] (ecmascript)",
      ...
      (function () {
            ...
            if (jsxChildrenParents.has(objectOrArray)) {
              ...
              for (var i = 0; i < objectOrArray.length; i++) {
                ...
                "" + i === expandedName
                  ...
                  : (objKind =
                      15 > value.length && 40 > objKind.length + value.length ? objKind + value : objKind + "{...}");
              }
              objKind += "</" + describeElementType(type) + ">";
            } else {
              objKind = "[";
                    ...
                    if (
                      ...
                      "children" === propKey
                        ...
                        : hasOwnProperty.call(value, propKey) &&
                          "_" !== propKey[0] &&
                          addValueToProperties(propKey, value[propKey], properties, indent + 1, prefix),
                      100 <= key)
                    )
                      break;
                  ...
                  if (((typeName = 100 < value.length), (key = getArrayKind(value)), 2 === key || 0 === key)) {
                    ...
                    for (propertyName = 0; propertyName < value.length && 100 > propertyName; propertyName++)
                      ((propKey = value[propertyName]),
                        addValueToProperties(propKey[0], propKey[1], properties, indent + 1, prefix));
          ...
          if (supportsUserTiming && 0 < endTime) {
            ...
            if (debugTask) {
              ...
              "object" === typeof value && null !== value
                ...
                : void 0 !== value && addValueToProperties("awaited value", value, properties, 0, "");
        ...
        function createPendingChunk(response) {
          0 === response._pendingChunks++ &&
            ...
            null !== response._pendingInitialRender &&
              (clearTimeout(response._pendingInitialRender), (response._pendingInitialRender = null)));
        ...
        function resolveModelChunk(response, chunk, value) {
          if ("pending" !== chunk.status) chunk.reason.enqueueModel(value);
            ...
            null !== resolveListeners &&
              (initializeModelChunk(chunk), wakeChunkIfInitialized(response, chunk, resolveListeners, rejectListeners));
          }
        }
            ...
            for (var debugInfo = [], i = 0; i < value.length; ) {
              ...
              if (void 0 === ioInfo) {
                ...
                if ("function" === typeof performance.getEntriesByType)
                  for (
                    var resourceEntries = performance.getEntriesByType("resource"), i$jscomp$0 = 0;
        ...
        function initializeElement(response, element, lazyNode) {
          ...
          null === owner && null != response._debugRootStack
            ...
            : null !== stack && (normalizedStackTrace = createFakeJSXCallStackInDEV(response, stack, env));
          element._debugStack = normalizedStackTrace;
          normalizedStackTrace = null;
          supportsCreateTask &&
            null !== stack &&
            ((normalizedStackTrace = console.createTask.bind(console, getTaskName(element.type))),
            (stack = buildFakeCallStack(response, stack, env, !1, normalizedStackTrace)),
            (env = null === owner ? null : initializeFakeTask(response, owner)),
            null === env
              ? ((env = response._debugRootTask), (normalizedStackTrace = null != env ? env.run(stack) : stack()))
                ...
                null !== resolvedValue &&
                  ...
                  null !== boundArgs
                    ...
                    : ((boundArgs = handler.value),
                      ...
                      moveDebugInfoFromChunkToInnerValue(resolvedValue, boundArgs))));
            },
            function (error) {
              if (!handler.errored) {
                var blockedValue = handler.value;
        ...
        function getOutlinedModel(response, reference, parentObject, key, map) {
          ...
          switch (reference.status) {
            case "fulfilled":
              ...
              (parentObject[0] !== REACT_ELEMENT_TYPE || ("4" !== key && "5" !== key)) &&
          ...
          if ("$" === value[0]) {
            ...
            switch (value[1]) {
              ...
              case "E":
                ...
                try {
                  if (
                    ((ref = getInferredFunctionApproximate(response)), response.startsWith("Object.defineProperty("))
                  ) {
        ...
        function ResponseInstance(
          ...
          supportsCreateTask &&
            (this._debugRootTask = console.createTask('"use ' + environmentName.toLowerCase() + '"'));
        ...
        function incrementChunkDebugInfo(streamState, chunkLength) {
          ...
          chunkLength > streamState._debugTargetChunkSize || endTime > previousEndTime + 10
            ? ((streamState._debugInfo = {
                name: debugInfo.name,
        ...
        function resolveChunkDebugInfo(response, streamState, chunk) {
          response._debugIOStarted &&
            ...
            "pending" === chunk.status || "blocked" === chunk.status
              ? ((response = addAsyncInfo.bind(null, chunk, response)), chunk.then(response, response))
            ...
            if ((resolveChunkDebugInfo(response, streamState, chunk), "pending" === chunk.status)) {
              ...
              if (null != chunk._debugChunk) {
                ...
                try {
                  if (
                    (initializeDebugChunk(response, chunk),
                    null !== initializingHandler && !initializingHandler.errored && 0 < initializingHandler.deps)
                  ) {
              ...
              null !== id
                ...
                : (filterDebugInfo(response, chunk), moveDebugInfoFromChunkToInnerValue(chunk, stream));
            }
          } else
            ...
            iterator ? iterable[ASYNC_ITERATOR]() : iterable,
            {
              ...
              enqueueModel: function (value) {
                nextWriteIndex === buffer.length
                  ...
                  : resolveIteratorResultChunk(response, buffer[nextWriteIndex], value, !1);
                nextWriteIndex++;
              },
              close: function (value) {
                ...
                nextWriteIndex === buffer.length
                  ...
                  : resolveIteratorResultChunk(response, buffer[nextWriteIndex], value, !0);
                for (nextWriteIndex++; nextWriteIndex < buffer.length; )
                  resolveIteratorResultChunk(response, buffer[nextWriteIndex++], '"$undefined"', !0);
              },
              error: function (error) {
                closed = !0;
                for (
        ...
        function resolveErrorDev(response, errorInfo) {
          ...
          null === ownerTask
            ? ((response = getRootTask(response, env)), (error = null != response ? response.run(error) : error()))
        ...
        function createFakeFunction(
          ...
          1 > line
            ? ((line = encodedName.length + 3),
              ...
              0 > col && (col = 0),
              (encodedName = "({" + encodedName + ":" + " ".repeat(enclosingCol) + "_=>" + " ".repeat(col) + "_()})"))
            : 1 > enclosingLine
        ...
        function getRootTask(response, childEnvironmentName) {
          ...
          return rootTask
            ? response._rootEnvironmentName !== childEnvironmentName
              ? ((response = console.createTask.bind(console, '"use ' + childEnvironmentName.toLowerCase() + '"')),
        ...
        function initializeFakeTask(response, debugInfo) {
          ...
          null === ownerTask
            ? ((response = getRootTask(response, cachedEntry)),
              (response = null != response ? response.run(useEnclosingLine) : useEnclosingLine()))
        ...
        function resolveIOInfo(response, id, model) {
          ...
          chunk
            ? (resolveModelChunk(response, chunk, model),
              "resolved_model" === chunk.status && initializeModelChunk(chunk))
            : ((chunk = createResolvedModelChunk(response, model)), chunks.set(id, chunk), initializeModelChunk(chunk));
          "fulfilled" === chunk.status
        ...
        function flushComponentPerformance(response$jscomp$0, root, trackIdx$jscomp$6, trackTime, parentEndTime) {
          if (!isArrayImpl(root._children)) {
            ...
            if (-Infinity < parentEndTime && parentEndTime < previousEndTime && null !== previousResult.component) {
              ...
              if (supportsUserTiming && 0 <= previousEndTime && 10 > trackIdx) {
                var color =
                    componentInfo.env === response$jscomp$0._rootEnvironmentName ? "primary-light" : "secondary-light",
          ...
          for (
            var childrenEndTime = -Infinity, childTrackIdx = trackIdx$jscomp$6, childTrackTime = trackTime, _i5 = 0;
            _i5 < children.length;
            _i5++
          ) {
          ...
          if (debugInfo)
            for (
              var componentEndTime = 0, isLastComponent = !0, endTime = -1, endTimeIdx = -1, _i6 = debugInfo.length - 1;
              0 <= _i6;
              _i6--
            ) {
                      ...
                      if (isLastComponent && "rejected" === root.status && root.reason !== response._closedReason) {
                        ...
                        if (supportsUserTiming) {
                          ...
                          null != componentInfo$jscomp$2.key &&
                            addValueToProperties("key", componentInfo$jscomp$2.key, properties, 0, "");
                        ...
                        if (supportsUserTiming && 0 <= childrenEndTime$jscomp$2 && 10 > trackIdx$jscomp$2) {
                          ...
                          if (debugTask$jscomp$0) {
                            ...
                            null != componentInfo$jscomp$3.key &&
                              addValueToProperties("key", componentInfo$jscomp$3.key, properties$jscomp$0, 0, "");
                            null != componentInfo$jscomp$3.props &&
                              addObjectToProperties(componentInfo$jscomp$3.props, properties$jscomp$0, 0, "");
                          ...
                          case "rejected":
                            ...
                            if (supportsUserTiming && 0 < endTime$jscomp$0) {
                              var description = getIODescription(error$jscomp$0),
                                ...
                                debugTask$jscomp$1 =
                                  asyncInfo$jscomp$0.debugTask || asyncInfo$jscomp$0.awaited.debugTask;
                    ...
                    if ("string" === typeof _candidateInfo.name) {
                      ...
                      if (supportsUserTiming) {
                        var env$jscomp$2 = componentInfo$jscomp$4.env,
                          ...
                          properties$jscomp$2 = [
                            ["Aborted", "The stream was aborted before this Component finished rendering."],
                          ];
                        null != componentInfo$jscomp$4.key &&
                          addValueToProperties("key", componentInfo$jscomp$4.key, properties$jscomp$2, 0, "");
                        null != componentInfo$jscomp$4.props &&
                          addObjectToProperties(componentInfo$jscomp$4.props, properties$jscomp$2, 0, "");
                      ...
                      if (supportsUserTiming && 0 < endTime$jscomp$1) {
                        var entryName$jscomp$3 =
                            "await " +
                            getIOShortName(asyncInfo$jscomp$1.awaited, "", asyncInfo$jscomp$1.env, rootEnv$jscomp$0),
                        ...
                        if (debugTask$jscomp$2) {
                          var tooltipText$jscomp$0 =
                            getIOLongName(asyncInfo$jscomp$1.awaited, "", asyncInfo$jscomp$1.env, rootEnv$jscomp$0) +
                            " Aborted";
        ...
        function flushInitialRenderPerformance(response) {
          if (response._replayConsole) {
            ...
            isArrayImpl(rootChunk._children) &&
              (markAllTracksInOrder(), flushComponentPerformance(response, rootChunk, 0, -Infinity, -Infinity));
          }
        }
        ...
        function processFullStringRow(response, streamState, id, tag, row) {
          switch (tag) {
            ...
            case 69:
              ...
              chunk
                ? (resolveChunkDebugInfo(response, streamState, chunk), triggerErrorOnChunk(response, chunk, error))
            ...
            default:
              if ("" === row) {
                if (
                  ...
                  (row = streamState.get(id)) || streamState.set(id, (row = createPendingChunk(response))),
                ...
                ((tag = response._chunks),
                  (chunk = tag.get(id))
                    ? (resolveChunkDebugInfo(response, streamState, chunk), resolveModelChunk(response, chunk, row))
            ...
            for (incrementChunkDebugInfo(streamState, chunkLength); i < chunkLength; ) {
              ...
              switch (rowState) {
                case 0:
                  ...
                  58 === lastIdx
                    ? (rowState = 1)
                    : (weakResponse = (weakResponse << 4) | (96 < lastIdx ? lastIdx - 87 : lastIdx - 48));
                  continue;
                case 1:
                  rowState = chunk[i];
                  84 === rowState ||
                  ...
                  86 === rowState
                    ...
                    : (64 < rowState && 91 > rowState) || 35 === rowState || 114 === rowState || 120 === rowState
              ...
              if (-1 < lastIdx)
                ((rowLength = new Uint8Array(chunk.buffer, offset, lastIdx - i)),
                  processFullBinaryRow(response, streamState, weakResponse, rowTag, buffer, rowLength),
                  (i = lastIdx),
                  3 === rowState && i++,
                ...
                for (incrementChunkDebugInfo(_ref, chunkLength); i < chunkLength; ) {
                  ...
                  switch (rowState) {
                    ...
                    case 1:
                      ...
                      86 === rowState
                        ? ((rowTag = rowState), (rowState = 2), i++)
                        : (64 < rowState && 91 > rowState) || 114 === rowState || 120 === rowState
                          ? ((rowTag = rowState), (rowState = 3), i++)
                          : ((rowTag = 0), (rowState = 3));
                      continue;
                    case 2:
        ...
        var debugChannelRegistry =
            "function" === typeof FinalizationRegistry ? new FinalizationRegistry(closeDebugChannel) : null,
          initializingHandler = null,
  ...
  "[project]/in-need-of-time/node_modules/next/dist/compiled/react-server-dom-turbopack/client.browser.js [app-client] (ecmascript)",
  (__turbopack_context__, module, exports) => {
    "use strict";
...
//# sourceMappingURL=433da_next_dist_compiled_react-server-dom-turbopack_2b6f6914._.js.map
