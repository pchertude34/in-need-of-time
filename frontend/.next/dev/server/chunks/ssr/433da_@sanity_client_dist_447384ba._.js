module.exports = [
  "[project]/in-need-of-time/node_modules/@sanity/client/dist/_chunks-es/stegaClean.js [app-rsc] (ecmascript)",
  ...
  "[project]/in-need-of-time/node_modules/@sanity/client/dist/_chunks-es/isRecord.js [app-rsc] (ecmascript)",
  (__turbopack_context__) => {
    "use strict";

    __turbopack_context__.s(["isRecord", () => isRecord]);
    function isRecord(value) {
      return typeof value == "object" && value !== null && !Array.isArray(value);
    }
    //# sourceMappingURL=isRecord.js.map
  },
  "[project]/in-need-of-time/node_modules/@sanity/client/dist/_chunks-es/resolveEditInfo.js [app-rsc] (ecmascript)",
  (__turbopack_context__) => {
    "use strict";
    ...
    var __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$_chunks$2d$es$2f$isRecord$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ =
    ...
    function isKeySegment(segment) {
      return typeof segment == "string"
        ? reKeySegment.test(segment.trim())
    ...
    function get(obj, path, defaultVal) {
      ...
      for (let i = 0; i < select.length; i++) {
        ...
        if (
          (typeof segment == "string" && (acc = typeof acc == "object" && acc !== null ? acc[segment] : void 0),
          typeof acc > "u")
        )
          return defaultVal;
      }
    ...
    function parsePathSegment(segment) {
      return isIndexSegment(segment)
        ? parseIndexSegment(segment)
        : isKeySegment(segment)
          ? parseKeySegment(segment)
          : isIndexTuple(segment)
            ? parseIndexTupleSegment(segment)
            : segment;
    }
    ...
    function getPublishedId(id) {
      return isVersionId(id)
        ? id.split(PATH_SEPARATOR).slice(2).join(PATH_SEPARATOR)
        : isDraftId(id)
          ? id.slice(DRAFTS_PREFIX.length)
          : id;
    }
    const ESCAPE = {
        "\f": "\\f",
...
`,
    ...
    function jsonPathArray(path) {
      return path.map((segment) =>
        typeof segment == "string"
          ? `['${segment.replace(/[\f\n\r\t'\\]/g, (match) => ESCAPE[match])}']`
          : typeof segment == "number"
            ? `[${segment}]`
            : segment._key !== ""
              ? `[?(@._key=='${segment._key.replace(/['\\]/g, (match) => ESCAPE[match])}')]`
              : `[${segment._index}]`,
      );
    }
    ...
    function walkMap(value, mappingFn, path = []) {
      if (isArray(value))
        return value.map((v, idx) => {
          if (
            (0,
            __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$_chunks$2d$es$2f$isRecord$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__[
              "isRecord"
            ])(v)
          ) {
            const _key = v._key;
        ...
        if (value._type === "block" || value._type === "span") {
          ...
          return (
            value._type === "block"
              ...
              : value._type === "span" && (result.text = walkMap(value.text, mappingFn, path.concat("text"))),
            result
          );
        }
    ...
    function createEditUrl(options) {
      ...
      if (
        (workspace && searchParams.set("workspace", workspace),
        tool && searchParams.set("tool", tool),
        projectId && searchParams.set("projectId", projectId),
        dataset && searchParams.set("dataset", dataset),
        isPublishedId(_id))
      )
      ...
      return (
        tool && routerParams.push(`tool=${tool}`),
    ...
    function resolveEditInfo(options) {
      const { resultSourceMap: csm, resultPath } = options,
        { mapping, pathSuffix } = resolveMapping(resultPath, csm) || {};
  ...
  (__turbopack_context__) => {
    ...
    var __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f$get$2d$it$2f$dist$2f$index$2e$react$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ =
      __turbopack_context__.i(
        "[project]/in-need-of-time/node_modules/get-it/dist/index.react-server.js [app-rsc] (ecmascript)",
      );
    var __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f$get$2d$it$2f$dist$2f$middleware$2e$browser$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__ =
      __turbopack_context__.i(
        "[project]/in-need-of-time/node_modules/get-it/dist/middleware.browser.js [app-rsc] (ecmascript) <locals>",
      );
    var __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ =
      __turbopack_context__.i("[project]/in-need-of-time/node_modules/rxjs/dist/cjs/index.js [app-rsc] (ecmascript)");
    var __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$_chunks$2d$es$2f$stegaClean$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ =
      __turbopack_context__.i(
        "[project]/in-need-of-time/node_modules/@sanity/client/dist/_chunks-es/stegaClean.js [app-rsc] (ecmascript)",
      );
    var __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$operators$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ =
      __turbopack_context__.i(
        "[project]/in-need-of-time/node_modules/rxjs/dist/cjs/operators/index.js [app-rsc] (ecmascript)",
      );
    var __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$_chunks$2d$es$2f$resolveEditInfo$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ =
      __turbopack_context__.i(
        "[project]/in-need-of-time/node_modules/@sanity/client/dist/_chunks-es/resolveEditInfo.js [app-rsc] (ecmascript)",
      );
    var __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f40$sanity$2f$client$2f$node_modules$2f$nanoid$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__ =
      __turbopack_context__.i(
        "[project]/in-need-of-time/node_modules/@sanity/client/node_modules/nanoid/index.js [app-rsc] (ecmascript) <locals>",
      );
    const NEWLINE = /\r\n|[\n\r\u2028\u2029]/;
    function codeFrame(query, location2, message) {
      const lines = query.split(NEWLINE),
        ...
        { start, end, markerLines } = getMarkerLines(loc, lines),
 ...
 `,
              ...
              lastMarkerLine && message && (markerLine += " " + message));
          }
...
`);
    ...
    function isHttpError(error) {
      if (
        !(0,
        __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$_chunks$2d$es$2f$stegaClean$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__[
          "isRecord"
        ])(error)
      )
        return !1;
...
- `)}`
          : "";
        return (
          allItems.length > MAX_ITEMS_IN_ERROR_MESSAGE &&
            (itemsStr += `
...and ${allItems.length - MAX_ITEMS_IN_ERROR_MESSAGE} more`),
      ...
      return "description" in error && typeof error.description == "string"
        ? ((props.message = error.description), (props.details = error), props)
        : ((props.message = httpErrorMessage(res, body)), props);
    }
...
${codeFrame(
  ...
  description,
    ...
    function stringifyBody(body, res) {
      return (res.headers["content-type"] || "").toLowerCase().indexOf("application/json") !== -1
    ...
    function printWarnings(config = {}) {
      const seen = {},
        shouldIgnoreWarning = (message) =>
          config.ignoreWarnings === void 0
            ? !1
            : (Array.isArray(config.ignoreWarnings) ? config.ignoreWarnings : [config.ignoreWarnings]).some(
                (pattern) =>
    ...
    function defineHttpRequest(envMiddleware2, config = {}) {
      return (0,
      __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f$get$2d$it$2f$dist$2f$index$2e$react$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__[
        "getIt"
      ])([
        (0,
        __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f$get$2d$it$2f$dist$2f$middleware$2e$browser$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__[
          "retry"
        ])({
          shouldRetry,
        }),
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f$get$2d$it$2f$dist$2f$middleware$2e$browser$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__[
          ...
          implementation:
            __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__[
              "Observable"
            ],
        }),
      ]);
    ...
    function shouldRetry(err, attempt, options) {
      ...
      const isSafe = options.method === "GET" || options.method === "HEAD",
        ...
        isRetriableResponse =
          err.response &&
          (err.response.statusCode === 429 || err.response.statusCode === 502 || err.response.statusCode === 503);
      return (isSafe || isQuery2) && isRetriableResponse
        ? !0
        : __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f$get$2d$it$2f$dist$2f$middleware$2e$browser$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__[
            "retry"
          ].shouldRetry(err, attempt, options);
    }
    ...
    const createWarningPrinter = (
        message, // eslint-disable-next-line no-console
    ...
    const initConfig = (config, prevConfig) => {
      ...
      newConfig["~experimental_resource"] &&
        !newConfig.resource &&
        (printDeprecatedResourceConfigWarning(), (newConfig.resource = newConfig["~experimental_resource"]));
      ...
      if (
        (resourceConfig$1 && resourceConfig(newConfig),
        typeof newConfig.perspective < "u" && validateApiPerspective(newConfig.perspective),
      ...
      const isBrowser =
          ("TURBOPACK compile-time value", "undefined") < "u" && window.location && window.location.hostname,
        isLocalhost = isBrowser && isLocal(window.location.hostname),
        hasToken = !!newConfig.token;
      (newConfig.withCredentials && hasToken && (printCredentialedTokenWarning(), (newConfig.withCredentials = !1)),
        isBrowser && isLocalhost && hasToken && newConfig.ignoreBrowserTokenWarning !== !0
          ? printBrowserTokenWarning()
          : typeof newConfig.useCdn > "u" && printCdnWarning(),
        projectBased && projectId(newConfig.projectId),
        newConfig.dataset && dataset(newConfig.dataset),
        "requestTagPrefix" in newConfig &&
        ...
        (newConfig.useCdn = newConfig.useCdn !== !1 && !newConfig.withCredentials),
      ...
      return (
        projectBased
          ...
          : ((newConfig.url = `${newConfig.apiHost}/v${newConfig.apiVersion}`), (newConfig.cdnUrl = newConfig.url)),
        newConfig
      );
    };
    ...
    function connectEventSource(initEventSource, events) {
      ...
      __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__[
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__[
          "mergeMap"
        ])((es) => connectWithESInstance(es, events)),
      );
    }
    function connectWithESInstance(es, events) {
      return new __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__[
        "Observable"
      ]((observer) => {
        ...
        const cleanedEvents = [.../* @__PURE__ */ new Set([...REQUIRED_EVENTS, ...events])].filter(
          (type) => type !== "error" && type !== "open" && type !== "reconnect",
        );
        return (
          cleanedEvents.forEach((type) => es.addEventListener(type, onMessage)),
          () => {
            (es.removeEventListener("error", onError),
              emitOpen && es.removeEventListener("open", onOpen),
              cleanedEvents.forEach((type) => es.removeEventListener(type, onMessage)),
              es.close());
          }
        );
      });
    ...
    function extractErrorMessage(err, tag) {
      ...
      return error
        ? isQueryParseError(error)
          ? formatQueryParseError(error, tag)
          : error.description
            ? error.description
            : typeof error == "string"
              ? error
              : JSON.stringify(error, null, 2)
        : err.message || "Unknown listener error";
    }
...
${selectionOpts}`);
    ...
    class Transaction extends BaseTransaction {
      ...
      patch(patchOrDocumentId, patchOps) {
        const isBuilder = typeof patchOps == "function",
          ...
          isMutationSelection =
            typeof patchOrDocumentId == "object" && ("query" in patchOrDocumentId || "id" in patchOrDocumentId);
        if (isPatch)
          return this._add({
    ...
    const encodeQueryString = ({ query, params = {}, options = {} }) => {
        ...
        return (
          returnQuery === !1 && searchParams.append("returnQuery", "false"),
          includeMutations === !1 && searchParams.append("includeMutations", "false"),
          `?${searchParams}`
        );
      },
      ...
      indexBy = (docs, attr) =>
        docs.reduce((indexed, doc) => ((indexed[attr(doc)] = doc), indexed), /* @__PURE__ */ Object.create(null)),
    ...
    function _fetch(client, httpRequest, _stega, query, _params = {}, options = {}) {
      ...
      return stega.enabled
        ? $request.pipe(
            (0,
            __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$operators$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__[
              "combineLatestWith"
            ])(
              (0,
              __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__[
                ...
                __turbopack_context__
                  ...
                  .then(({ stegaEncodeSourceMap }) => stegaEncodeSourceMap),
              ),
            ),
            (0,
            __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$operators$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__[
    ...
    function _getDocument(client, httpRequest, id, opts = {}) {
      const docId = (() => {
          ...
          const versionId = (0,
          __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$_chunks$2d$es$2f$resolveEditInfo$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__[
            "getVersionFromId"
          ])(id);
          if (!versionId) {
            if (
        ...
        options = {
          ...
          signal: opts.signal,
          query:
            opts.includeAllVersions !== void 0
              ? {
    ...
    function _createIfNotExists(client, httpRequest, doc, options) {
      return (
        ...
        _create(client, httpRequest, doc, "createIfNotExists", options)
      );
    }
    ...
    function _createVersion(client, httpRequest, doc, publishedId, options) {
      return (
        requireDocumentId("createVersion", doc),
        requireDocumentType("createVersion", doc),
    ...
    function _replaceVersion(client, httpRequest, doc, options) {
      return (
        requireDocumentId("replaceVersion", doc),
        requireDocumentType("replaceVersion", doc),
        _action(
          client,
          httpRequest,
          {
    ...
    function _mutate(client, httpRequest, mutations, options) {
      let mut;
      mutations instanceof Patch || mutations instanceof ObservablePatch
        ? (mut = {
            patch: mutations.serialize(),
          })
        : mutations instanceof Transaction || mutations instanceof ObservableTransaction
    ...
    function _dataRequest(client, httpRequest, endpoint, body, options = {}) {
      const isMutation = endpoint === "mutate",
        ...
        { timeout, token, tag, headers, returnQuery, lastLiveEventId, cacheMode } = options,
    ...
    function _requestObservable(client, httpRequest, options) {
      ...
      if (
        ...
        (typeof perspectiveOption < "u" &&
          ...
          ((Array.isArray(perspectiveOption) && perspectiveOption.length > 0) || // previewDrafts was renamed to drafts, but keep for backwards compat
            ...
            useCdn &&
            ((useCdn = !1), printCdnPreviewDraftsWarning())),
          options.lastLiveEventId &&
            (options.query = {
              ...options.query,
              lastLiveEventId: options.lastLiveEventId,
            }),
          options.returnQuery === !1 &&
            (options.query = {
              returnQuery: "false",
              ...options.query,
            }),
          useCdn &&
            options.cacheMode == "noStale" &&
            (options.query = {
              cacheMode: "noStale",
              ...options.query,
            }));
      ...
      const reqOptions = requestOptions(
        ...
        request =
          new __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__[
            "Observable"
    ...
    class AgentActionsClient {
       ...
       */ generate(request) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__[
          "lastValueFrom"
        ])(_generate(this.#client, this.#httpRequest, request));
      }
      /**
       * Transform a target document based on a source.
       * @param request - translation request
       */ transform(request) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__[
          "lastValueFrom"
        ])(_transform(this.#client, this.#httpRequest, request));
      }
      /**
       * Translate a target document based on a source.
       * @param request - translation request
       */ translate(request) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__[
          "lastValueFrom"
        ])(_translate(this.#client, this.#httpRequest, request));
      }
      /**
       ...
       */ prompt(request) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__[
          "lastValueFrom"
        ])(_prompt(this.#client, this.#httpRequest, request));
      }
      /**
       ...
       */ patch(request) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__[
          "lastValueFrom"
        ])(_patch(this.#client, this.#httpRequest, request));
      }
    }
    ...
    function _upload(client, httpRequest, assetType, body, opts = {}) {
      ...
      const config = client.config(),
        ...
        { tag, label, title, description, creditLine, filename, source } = options,
      ...
      return (
        source &&
          !isMediaLibrary &&
          ((query.sourceId = source.id), (query.sourceName = source.name), (query.sourceUrl = source.url)),
    ...
    function optionsFromFile(opts, file) {
      return typeof File > "u" || !(file instanceof File)
        ? opts
        : Object.assign(
            {
    ...
    var defaults = (obj, defaults2) =>
      Object.keys(defaults2)
        .concat(Object.keys(obj))
        .reduce((target, prop) => ((target[prop] = typeof obj[prop] > "u" ? defaults2[prop] : obj[prop]), target), {});
    const pick = (obj, props) =>
        props.reduce((selection, prop) => (typeof obj[prop] > "u" || (selection[prop] = obj[prop]), selection), {}),
      eventSourcePolyfill = (0,
      __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__[
        "defer"
      ])(() =>
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$operators$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__[
          "map"
        ])(({ default: EventSource2 }) => EventSource2),
        (0,
        __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__[
          "shareReplay"
        ])(1),
    ...
    function _listen(query, params, opts = {}) {
      ...
      if (uri.length > MAX_URL_LENGTH)
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__[
          "throwError"
        ])(() => new Error("Query too large for listener"));
      const listenFor = options.events ? options.events : ["mutation"],
        esOptions = {};
      return (
        withCredentials && (esOptions.withCredentials = !0),
        (token || configHeaders) &&
          ((esOptions.headers = {}),
          token && (esOptions.headers.Authorization = `Bearer ${token}`),
          configHeaders && Object.assign(esOptions.headers, configHeaders)),
        connectEventSource(
          () =>
            // use polyfill if there is no global EventSource or if we need to set headers
            (typeof EventSource > "u" || esOptions.headers
              ? eventSourcePolyfill
              : (0,
                __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__[
                  "of"
              ...
              __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$operators$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__[
                "map"
              ])((EventSource2) => new EventSource2(uri, esOptions)),
            ),
          listenFor,
        ).pipe(
          ...
          __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$operators$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__[
            "filter"
          ])((event) => listenFor.includes(event.type)),
          (0,
          __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$operators$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__[
            "map"
          ])((event) => ({
    ...
    class LiveClient {
       ...
       */ events({ includeDrafts = !1, tag: _tag } = {}) {
        ...
        (includeDrafts && withCredentials && (esOptions.withCredentials = !0),
          ((includeDrafts && token) || configHeaders) &&
            ((esOptions.headers = {}),
            includeDrafts && token && (esOptions.headers.Authorization = `Bearer ${token}`),
            configHeaders && Object.assign(esOptions.headers, configHeaders)));
        ...
        const events = connectEventSource(
            () =>
              ...
              (typeof EventSource > "u" || esOptions.headers
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$operators$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__[
                  "map"
                ])((EventSource2) => new EventSource2(url.href, esOptions)),
              ),
    ...
    class ObservableDatasetsClient {
       ...
       */ list() {
        ...
        let uri = "/datasets";
        return (
          config.useProjectHostname === !1 && (uri = `/projects/${projectId2}/datasets`),
    ...
    class DatasetsClient {
       ...
       */ delete(name) {
        return (
          ...
          __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__[
            "lastValueFrom"
          ])(_modify(this.#client, this.#httpRequest, "DELETE", name))
        );
      }
      /**
       * Fetch a list of datasets for the configured project
    ...
    function _modify(client, httpRequest, method, name, options) {
      return (
        resourceGuard("dataset", client.config()),
        dataset(name),
        _request(client, httpRequest, {
          method,
          uri: `/datasets/${name}`,
          body: options,
          tag: null,
    ...
    class MediaLibraryVideoClient {
       ...
       */ getPlaybackInfo(assetIdentifier, options = {}) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__[
          ...
          new ObservableMediaLibraryVideoClient(this.#client.observable, this.#httpRequest).getPlaybackInfo(
            assetIdentifier,
            options,
          ),
        );
    ...
    function buildQueryParams(options) {
      ...
      if (options.transformations) {
        ...
        (thumbnail &&
          (thumbnail.width && (params.thumbnailWidth = thumbnail.width),
          thumbnail.height && (params.thumbnailHeight = thumbnail.height),
          thumbnail.time !== void 0 && (params.thumbnailTime = thumbnail.time),
          thumbnail.fit && (params.thumbnailFit = thumbnail.fit),
          thumbnail.format && (params.thumbnailFormat = thumbnail.format)),
          animated &&
            (animated.width && (params.animatedWidth = animated.width),
            animated.height && (params.animatedHeight = animated.height),
            animated.start !== void 0 && (params.animatedStart = animated.start),
            animated.end !== void 0 && (params.animatedEnd = animated.end),
            animated.fps && (params.animatedFps = animated.fps),
            animated.format && (params.animatedFormat = animated.format)),
          storyboard && storyboard.format && (params.storyboardFormat = storyboard.format));
      }
    ...
    class ObservableProjectsClient {
      ...
      list(options) {
        const query = {},
          uri = "/projects";
        return (
          options?.includeMembers === !1 && (query.includeMembers = "false"),
          options?.organizationId && (query.organizationId = options.organizationId),
          _request(this.#client, this.#httpRequest, {
            uri,
            query,
          })
    ...
    const generateReleaseId = (0,
      __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f40$sanity$2f$client$2f$node_modules$2f$nanoid$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__[
        "customAlphabet"
      ])("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789", 8),
      getDocumentVersionId = (publishedId, releaseId) =>
        releaseId
          ? (0,
            __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$_chunks$2d$es$2f$resolveEditInfo$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__[
              "getVersionId"
    ...
    class ReleasesClient {
       ...
       */ get({ releaseId }, options) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__[
          "lastValueFrom"
        ])(_getDocument(this.#client, this.#httpRequest, `_.releases.${releaseId}`, options));
      }
       ...
       */ edit({ releaseId, patch }, options) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__[
          "lastValueFrom"
        ])(_action(this.#client, this.#httpRequest, editAction, options));
      }
      /**
       * @public
       *
       ...
       */ publish({ releaseId }, options) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__[
          "lastValueFrom"
        ])(_action(this.#client, this.#httpRequest, publishAction, options));
      }
      /**
       * @public
       *
       ...
       */ archive({ releaseId }, options) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__[
          "lastValueFrom"
        ])(_action(this.#client, this.#httpRequest, archiveAction, options));
      }
      /**
       * @public
       *
       ...
       */ unarchive({ releaseId }, options) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__[
          "lastValueFrom"
        ])(_action(this.#client, this.#httpRequest, unarchiveAction, options));
      }
      /**
       * @public
       *
       ...
       */ schedule({ releaseId, publishAt }, options) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__[
          "lastValueFrom"
        ])(_action(this.#client, this.#httpRequest, scheduleAction, options));
      }
      /**
       * @public
       *
       ...
       */ unschedule({ releaseId }, options) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__[
          "lastValueFrom"
        ])(_action(this.#client, this.#httpRequest, unscheduleAction, options));
      }
      /**
       * @public
       *
       ...
       */ delete({ releaseId }, options) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__[
          "lastValueFrom"
        ])(_action(this.#client, this.#httpRequest, deleteAction, options));
      }
      /**
       * @public
       *
       ...
       */ fetchDocuments({ releaseId }, options) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__[
          "lastValueFrom"
        ])(_getReleaseDocuments(this.#client, this.#httpRequest, releaseId, options));
      }
    }
    ...
    class SanityClient {
      ...
      config(newConfig) {
        ...
        return (
          this.observable && this.observable.config(newConfig),
      ...
      fetch(query, params, options) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__[
          "lastValueFrom"
        ])(_fetch(this, this.#httpRequest, this.#clientConfig.stega, query, params, options));
      }
      getDocument(id, options) {
        if (options?.includeAllVersions === !0)
          return (0,
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__[
          "lastValueFrom"
        ])(_getDocument(this, this.#httpRequest, id, opts));
      }
      /**
       * Fetch multiple documents in one request.
       * Should be used sparingly - performing a query is usually a better option.
       ...
       */ getDocuments(ids, options) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__[
          "lastValueFrom"
        ])(_getDocuments(this, this.#httpRequest, ids, options));
      }
      create(document, options) {
        return (0,
        __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__[
      ...
      createVersion({ document, publishedId, releaseId, baseId, ifBaseRevisionId }, options) {
        if (!document)
          ...
          __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__[
            ...
            _createVersionFromBase(this, this.#httpRequest, publishedId, baseId, releaseId, ifBaseRevisionId, options),
          );
        const documentVersionId = deriveDocumentVersionId("createVersion", {
            document,
            publishedId,
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__[
          "firstValueFrom"
        ])(_createVersion(this, this.#httpRequest, documentVersion, versionPublishedId, options));
      }
      delete(selection, options) {
        return (0,
        __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__[
          "lastValueFrom"
        ])(_delete(this, this.#httpRequest, selection, options));
      }
      /**
       * @public
       *
      ...
      mutate(operations, options) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__[
          "lastValueFrom"
        ])(_mutate(this, this.#httpRequest, operations, options));
      }
      /**
       * Create a new buildable patch of operations to perform
       *
       ...
       */ action(operations, options) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__[
          "lastValueFrom"
        ])(_action(this, this.#httpRequest, operations, options));
      }
      /**
       ...
       */ request(options) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__[
          "lastValueFrom"
        ])(_request(this, this.#httpRequest, options));
      }
      /**
       ...
       */ dataRequest(endpoint, body, options) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$in$2d$need$2d$of$2d$time$2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__[
          "lastValueFrom"
        ])(_dataRequest(this, this.#httpRequest, endpoint, body, options));
      }
      /**
       * Get a Sanity API URL for the URI provided
       *
...
//# sourceMappingURL=433da_%40sanity_client_dist_447384ba._.js.map
