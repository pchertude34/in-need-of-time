...
export function ProviderMapPopup(props: ProviderMapPopupProps) {
  ...
  return (
    <div className="after:border-t-primary-600 absolute bottom-[8px] left-0 w-full after:absolute after:left-0 after:top-0 after:h-0 after:w-0 after:-translate-x-2/4 after:border-l-[6px] after:border-r-[6px] after:border-t-[8px] after:border-l-transparent after:border-r-transparent after:content-['']">
      <div className="padding-[5px] bg-primary-600 absolute left-0 top-0 -translate-x-2/4 -translate-y-full overflow-y-auto rounded-xl shadow-2xl">
