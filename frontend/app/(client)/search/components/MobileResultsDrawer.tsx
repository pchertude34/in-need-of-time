    ...
    >
      <Drawer.Portal>
        <Drawer.Content
          ...
          className="focus-ring-none border-b-none fixed right-0 bottom-0 left-0 z-20 mx-[-1px] flex h-full max-h-[calc(100dvh-88px)] flex-col rounded-t-xl border border-t border-slate-300 bg-white lg:hidden"
        >
